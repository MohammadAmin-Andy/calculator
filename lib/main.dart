...
void main() {
  runApp(
    CalculatorApplicaton(),
  );
}

class CalculatorApplicaton extends StatefulWidget {
  const CalculatorApplicaton({Key? key}) : super(key: key);

  @override
  State<CalculatorApplicaton> createState() => _CalculatorApplicatonState();
}
